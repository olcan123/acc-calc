<template>
    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <tr>
            ...
            <th scope="col" class="px-3 py-3 min-w-[80px] border-r-2 border-gray-300 dark:border-gray-600">KDV</th>
            ...
            <th scope="col" class="px-3 py-3 min-w-[100px]">Maliyet Fiyatı</th>
            ...
            <th scope="col" class="px-3 py-3 min-w-[100px]">Maliyet Tutarı</th>
            <th scope="col" class="px-3 py-3 min-w-[100px]">KDV Tutarı</th>
            <th scope="col" class="px-3 py-3 min-w-[120px] border-r-2 border-gray-300 dark:border-gray-600">
                Toplam Tutar
            </th>
