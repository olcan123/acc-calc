    ...
    <div class="p-6 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 text-sm">
            <div class="flex justify-between">
                <span class="text-gray-600 dark:text-gray-400">Totali i Shumës:</span>
            ...
            <div class="flex justify-between">
                <span class="text-gray-600 dark:text-gray-400">Shuma Neto:</span>
                <span class="font-medium">{{ formatCurrency(totals.netAmount) }}</span>
            </div>
            <div class="flex justify-between">
                <span class="text-gray-600 dark:text-gray-400">TVSH:</span>
