    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankAccountCompany", x => new { x.BankAccountsId, x.CompaniesId });
                    table.ForeignKey(
                        name: "FK_BankAccountCompany_BankAccounts_BankAccountsId",
                        column: x => x.BankAccountsId,
                        principalTable: "BankAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BankAccountCompany_Companies_CompaniesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_BankAccounts_BankAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressWarehouse", x => new { x.AddressesId, x.WarehousesId });
                    table.ForeignKey(
                        name: "FK_AddressWarehouse_Addresses_AddressesId",
                        column: x => x.AddressesId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AddressWarehouse_Warehouses_WarehousesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactWarehouse", x => new { x.ContactsId, x.WarehousesId });
                    table.ForeignKey(
                        name: "FK_ContactWarehouse_Contacts_ContactsId",
                        column: x => x.ContactsId,
                        principalTable: "Contacts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactWarehouse_Warehouses_WarehousesId",
                        column: x => x.WarehousesId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddressWarehouse_WarehousesId",
                table: "AddressWarehouse",
                column: "WarehousesId");

            migrationBuilder.CreateIndex(
                name: "IX_BankAccountCompany_CompaniesId",
                table: "BankAccountCompany",
                column: "CompaniesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_BankAccountId",
                table: "Contacts",
                column: "BankAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactWarehouse_WarehousesId",
                table: "ContactWarehouse",
                column: "WarehousesId");
